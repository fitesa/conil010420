...
var style_EvolucionIndicedeHumedad_1 = function(feature, resolution){
    ...
    if (value >= -0.285925 && value <= -0.198531) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.198531 && value <= -0.111136) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.111136 && value <= -0.023742) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.023742 && value <= 0.063652) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.063652 && value <= 0.151047) {
            style = [ new ol.style.Style({
