...
var style_IndicedeVegetacion_4 = function(feature, resolution){
    ...
    if (value >= 0.253325 && value <= 0.388287) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.388287 && value <= 0.523249) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.523249 && value <= 0.658212) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.658212 && value <= 0.793174) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.793174 && value <= 0.928136) {
            style = [ new ol.style.Style({
