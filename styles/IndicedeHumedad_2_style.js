...
var style_IndicedeHumedad_2 = function(feature, resolution){
    ...
    if (value >= -0.081749 && value <= 0.040009) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.040009 && value <= 0.161768) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.161768 && value <= 0.283526) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.283526 && value <= 0.405284) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.405284 && value <= 0.527043) {
            style = [ new ol.style.Style({
